...
from services.stats import compute_stats,  compute_tag_stats
...
def main():
    ...
    while True:
        ...
        print("8. Compute inventory statistics")
        print("9. Exit")
        ...
        match choice:
            ...
            case '7':
                service.discount()
            case '8':
                compute_stats(service.inventory)
                tag = input("Enter tag to compute statistics for: ")
                compute_tag_stats(service.inventory, tag)
            case '9':
                print("Exiting !")
                break
            case _:
